{%- macro dx_flag_flu_like(db) -%}
    ...
    {% if db == "SID" %}
        I10_DX1 IN {{flu_like_codes}} OR 
        I10_DX2 IN {{flu_like_codes}}
    {% else %}
        I10_DX_Visit_Reason1 IN {{flu_like_codes}} OR 
        I10_DX_Visit_Reason2 IN {{flu_like_codes}} OR 
        I10_DX1 IN {{flu_like_codes}} OR 
        I10_DX2 IN {{flu_like_codes}}
    {% endif %}
